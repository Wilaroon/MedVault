const NAV = [
  { key: 'dashboard', label: 'Dashboard', d: 'M3 3h7v9H3z M14 3h7v5h-7z M14 12h7v9h-7z M3 16h7v5H3z' },
  { key: 'pacientes', label: 'Pacientes', d: 'M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2 M11 7a4 4 0 1 1-8 0 4 4 0 0 1 8 0 M22 21v-2a4 4 0 0 0-3-3.87 M16 3.13a4 4 0 0 1 0 7.75' },
  { key: 'consultas', label: 'Consultas', d: 'M9 4H7a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-2 M9 4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2 M9 12h6 M9 16h4' },
  { key: 'alertas', label: 'Alertas', d: 'M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0z M12 9v4 M12 17h.01' },
  { key: 'auditoria', label: 'Auditoría', d: 'M14 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8z M14 3v5h5 M9 13h5 M9 17h4' }
];
...
export default function Sidebar({ screen, onNavigate, user }) {
  return (
    <aside style={asideStyle}>
      ...
      <div style={{ padding: '16px 22px', borderTop: '1px solid #EEF2F5', display: 'flex', alignItems: 'center', gap: '11px' }}>
        <div style={{
          ...
          {(user?.rol || 'MD').slice(0, 2).toUpperCase()}
        </div>
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ fontSize: '13px', fontWeight: 700, color: '#0A2540' }}>{user?.rol || 'Médico'}</div>
